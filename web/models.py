...
# ---------------------------------------------------------------------------
# Stub models needed for FK resolution (from other units)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Core models for this unit: Sample Collection & Tags
# ---------------------------------------------------------------------------
...
class SpeakerSample(Base):
    ...
    accent_strength = Column(Float, nullable=True)        # 0.0-1.0, computed
    is_curated = Column(Integer, default=0)               # 1 = verified good quality
    notes = Column(Text, default="")
    created_at = Column(DateTime, default=lambda: datetime.now(timezone.utc))
