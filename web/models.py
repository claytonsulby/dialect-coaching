...
# ---------------------------------------------------------------------------
# Stub models for FK resolution (created by other units)
# ---------------------------------------------------------------------------
...
class SpeakerSample(Base):
    ...
    tags = relationship("Tag", secondary=sample_tag)


# ---------------------------------------------------------------------------
# ImportJob model for external corpus imports
# ---------------------------------------------------------------------------
...
class ImportJob(Base):
    ...
    id = Column(Integer, primary_key=True)
    source = Column(String, nullable=False)            # "idea", "speech_accent_archive", "csv"
